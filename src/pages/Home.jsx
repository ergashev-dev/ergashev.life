...
import profilePic from '../assets/images/ergashev.jpg';
...
const Home = ({ socialLinks }) => {
    ...
    useSEO({
        title: 'Abdurashid Ergashev',
        description: 'Fullstack Developer from Uzbekistan. I write about non-technical stuff in the technical world.',
    });
                ...
                <div className="row justify-between">
                    <div className="col-xl-8 col-lg-10 col-12 stagger-animation" ref={animRef}>
                        <div className="about flex align-items-center">
                            <img className="anim-item profile-picture" src={profilePic} alt="Abdurashid" />
                            <div className="about-detail anim-item">
                                <h1 className="title">Abdurashid Ergashev</h1>
                                <h3 className="desc">Fullstack developer</h3>
